...
export class PaginatorStyleDirective {
  ...
  private buildPageNumbers() {
    ...
    this.ren.insertBefore(
      actionContainer,
      this.createButton(this.matPag.pageIndex, this.matPag.pageIndex),
      nextPageNode
    );
  }

  private createButton(i: any, pageIndex: number): any {
    const linkBtn: MatButton = this.ren.createElement("p");
    this.ren.addClass(linkBtn, "paginator-pageindex");
    const pagingTxt = i + 1;
    const text = this.ren.createText("Pagina " + pagingTxt);
